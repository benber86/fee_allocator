...
def prepare_actions(fee_allocator):
    ...
    approve_allocator_for_crvusd_spend_calldata = HOOKER.one_time_hooks.prepare_calldata(
            [
                (
                    CRVUSD.address,
                    CRVUSD.approve.prepare_calldata(
    ...
    create_community_fund_allocation_call_data = fee_allocator.set_receiver.prepare_calldata(
