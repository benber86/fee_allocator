...
def test_deployment(admin,
    ...
    print(f"{header[0]:<12} {header[1]:>10} {header[2]:>10} {header[3]:>10} {header[4]:>18}")
    for row in table:
        print(f"{row[0]:<12} {row[1]:>10.2f} {row[2]:>10.2f} {row[3]:>10.2f} {pct(row[4]):>18}")
